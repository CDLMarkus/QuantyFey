...
tryCatch({
  ...
  plot(p, height = 1.5) # Set height to about 2/3 of default (default is 3)
  ...
  cat("Weighted bracketing was used for quantification. The plot above shows the distribution of weights and the calibration samples used for each block.\\newline \n")
...
```{r, echo = F, warnings = F, error= F}
  ...
  p <- ggplot() + geom_point(data = rv$selection_cals_table[[1]], aes(x = Concentration, y = PeakArea, col = used)) + 
